...
class ResultatControllerSpec extends Specification implements ControllerUnitTest<ResultatController>, DomainUnitTest<Resultat> {
    ...
    void "Test the save action correctly persists"() {
        ...
        def resultat = new Resultat(params)
        resultat.id = 1

        controller.save(resultat)
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.resultatService = Mock(ResultatService) {
            1 * save(_ as Resultat) >> { Resultat resultat ->
                throw new ValidationException("Invalid instance", resultat.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.resultat instanceof Resultat
    }
